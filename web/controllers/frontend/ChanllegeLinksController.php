...
class ChanllegeLinksController extends BaseController
{
    public function actionValid()
    {
        try {
            $model = new ChanllegeLinks();
    ...
    public function actionIndex()
    {
        ...
        $entity_arr = ChanllegeEntity::getChildDict();
    ...
    public function actionCreate()
    {
        ...
        try {
            ...
            if (Yii::$app->request->post()) {
                ...
                $project_model->field_id    = Config::FIELD_CHANLLEGE;
    ...
    public function actionUpdate()
    {
        ...
        try {
            ...
            $model  = $this->findModel($id, ChanllegeLinks::class);
            ...
            if (Yii::$app->request->post()) {
                ...
                $project_model  = Project::find()
                    ->andWhere(["field_id" => Config::FIELD_CHANLLEGE])
    ...
    public function actionDelete()
    {
        try {
            ...
            $ids_str = explode(',',$ids);
            $query = ChanllegeLinks::find()->andWhere(['and',['in', 'id', $ids]]);
