...
class KnowledgeLinksController extends BaseController
{
    public function actionValid()
    {
        try {
            $model = new KnowledgeLinks();
    ...
    public function actionIndex()
    {
        ...
        $user_skill_model = new UserSkillLink;
        $user_skill_model->user_id = $this->user_obj->id;
        $skill_dict = $user_skill_model->getSkillDict();
    ...
    public function actionCreate()
    {
        ...
        try {
            ...
            if (Yii::$app->request->post()) {
                ...
                $project_model->field_id    = Config::FIELD_KNOWLEDGE;
                ...
                $user_skill_model = new UserSkillLink;
                $user_skill_model->user_id = $this->user_obj->id;
                $skill_dict = $user_skill_model->getSkillDict(true);
                $transaction->commit(); 
    ...
    public function actionUpdate()
    {
        ...
        try {
            ...
            $model  = $this->findModel($id, KnowledgeLinks::class);
            ...
            if (Yii::$app->request->post()) {
                ...
                $project_model  = Project::find()
                    ->andWhere(["field_id" => Config::FIELD_KNOWLEDGE])
    ...
    public function actionDelete()
    {
        try {
            ...
            $ids_str = explode(',',$ids);
            $query = KnowledgeLinks::find()->andWhere(['and',['in', 'id', $ids]]);
