...
class m170318_021946_entity_skill_table extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%entity_skill}}', [
            'id'          => Schema::TYPE_PK,
            'name'        => Schema::TYPE_STRING.' NOT NULL DEFAULT "" COMMENT "技能名称" ',
