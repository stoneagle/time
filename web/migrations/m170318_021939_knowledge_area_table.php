...
class m170318_021939_knowledge_area_table extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%knowledge_area}}', [
            'id'     => Schema::TYPE_PK,
            ...
            'area_id'  => Schema::TYPE_SMALLINT . ' NOT NULL DEFAULT 0 COMMENT "所属范畴id"',
