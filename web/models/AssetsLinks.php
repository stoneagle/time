...
class AssetsLinks extends BaseActiveRecord
{
    const TABLE_NAME    = "assets_user_link";
    public $project_name;
    public $priority_id;
    ...
    public function getQuery()
    {
        ...
        $query       = self::find()
            ...
            ->andFilterWhere(["$project_t.field_id" => Config::FIELD_ASSET])
