<div class="col-md-6 col-md-offset-3">
    ...
    $this->params['breadcrumbs'][] = ['label' => '艺术作品管理', 'url' => ['index']];
    ...
    <?= $form->field($model, 'year')->textInput(['placeholder' => '年份不能为空'])?>
    <?php 
            ...
            success: function(result) {
                ...
                if (data.error === 0) {
                    swal({
                        ...
                        id = data.data['id'];
                        window.location.href = "/frontend/art-work/index";
                    });
                } else {
