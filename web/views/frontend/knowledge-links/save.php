<div class="col-md-6 col-md-offset-3">
    ...
    $this->params['breadcrumbs'][] = ['label' => '技能训练管理', 'url' => ['index']];
    ...
    <?php 
        echo $form->field($model, 'entity_ids')->widget(
            Select2::className(), [
            'data' => $entityArr,
            'pluginOptions' => [
                'allowClear' => true,
            ...
            success: function(result) {
                ...
                if (data.error === 0) {
                    swal({
                        ...
                        id = data.data['id'];
                        window.location.href = "/frontend/knowledge-links/index";
                    });
                } else {
