...
$this->registerJsFile('@web/js/frontend/art-links/index.js',['depends'=>['app\assets\AppAsset']]);
?>
        ...
        <?php
         $gridColumns = [
                ...
                [
                    ...
                    'value' => function ($model) use($workArr) {
                        $work_list = explode(",", $model->work_ids);
                        foreach ($work_list as &$one) {
                            $one = ArrayHelper::getValue($workArr, $one);
                        }
                        return implode(',', $work_list);
                    },
                ],
                [
                    'attribute' => 'ctime',
