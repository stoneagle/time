...
$this->registerJsFile('@web/js/frontend/chanllege-entity/index.js',['depends'=>['app\assets\AppAsset']]);
?>
    ...
    <div data-pjax-timeout="1000" data-pjax-push-state="" data-pjax-container="" id="w0">
        ...
        <div class="grid-view" id="w1">
            <?= GridView::widget([
                ...
                'toolbar' => [
                    //$fullExportMenu,
                    Html::a('新建挑战实体',['create?'.$_SERVER['QUERY_STRING']],['data-pjax'      => 0, 'class' => 'btn btn-success',]),
                ],
